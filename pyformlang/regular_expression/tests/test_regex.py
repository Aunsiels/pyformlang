...
class TestRegex(unittest.TestCase):
    ...
    def test_creation(self):
        """ Try to create regex """
        regex = Regex("a|b")
        self.assertEqual(regex._get_number_symbols(), 2)
        self.assertEqual(regex._get_number_operators(), 1)
        regex = Regex("a b")
        self.assertEqual(regex._get_number_symbols(), 2)
        self.assertEqual(regex._get_number_operators(), 1)
        regex = Regex("a b c")
        self.assertEqual(regex._get_number_symbols(), 3)
        self.assertEqual(regex._get_number_operators(), 2)
        regex = Regex("(a b)|c")
        self.assertEqual(regex._get_number_symbols(), 3)
        self.assertEqual(regex._get_number_operators(), 2)
        regex = Regex("")
        self.assertEqual(regex._get_number_symbols(), 1)
        self.assertEqual(regex._get_number_operators(), 0)
        regex = Regex("a*")
        self.assertEqual(regex._get_number_symbols(), 1)
        self.assertEqual(regex._get_number_operators(), 1)
        regex = Regex("a**")
        ...
        regex = Regex("a*b|c")
        self.assertEqual(regex._get_number_symbols(), 3)
        self.assertEqual(regex._get_number_operators(), 3)
        regex = Regex("a*(b|c)")
        self.assertEqual(regex._get_number_symbols(), 3)
        self.assertEqual(regex._get_number_operators(), 3)
        regex = Regex("a*.(b|c)")
        ...
        self.assertEqual(regex._get_number_symbols(), 4)
        self.assertEqual(regex._get_number_operators(), 4)
        regex = Regex("$")
        self.assertEqual(regex._get_number_symbols(), 1)
        regex = Regex("a|")
        self.assertEqual(regex._get_number_symbols(), 2)
